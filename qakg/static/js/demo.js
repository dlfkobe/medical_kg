document.onkeydown = function (){
	...
	$("#ui_inp_msg").val("");
	var sendhtml='<li class="t2"><img src="../static/duola2.jpg"><div class="txt">'+msg+'</div></li>';
	...
	$.ajax({
		...
		success:function(data){
				var content = data
					var sendhtml='<li class="t1"><img src="../static/xf_head.jpg"><div class="txt">'+content+'</div></li>';
					$("#ui_msg_box").append(sendhtml);
			// 将展示消息的滚动条滑到底部
			scrollMsgBottom();
		},
